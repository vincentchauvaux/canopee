...
**Uniquement des morceaux ≥ 1 heure.**

## Zen

| Fichier | Titre | Artiste | Source | Licence |
|---------|-------|---------|--------|---------|
| `zen/ambient-groove-mix.mp3` | Ambient Groove Mix (~1 h) | ambientgroove.net | [Internet Archive](https://archive.org/details/ambientgroove.net_mix1) | CC BY-ND 3.0 |
...
| Fichier | Titre | Artiste | Source | Licence |
|---------|-------|---------|--------|---------|
| `om/om-chanting-528hz.mp3` | Chant OM @ 528 Hz (~1 h 42) | OM Chanting | [Internet Archive](https://archive.org/details/yt-5s.com-om-chanting-528-hz-320-kbps) | Internet Archive |
| `om/om-vibrations-1h.mp3` | Vibrations OM — énergie positive (~1 h) | OM Mantras | [Internet Archive](https://archive.org/details/GETPOSITIVEENERGYAURASUPERPOWERFULVIBRATIONSOMZOOM) | Internet Archive |
...
| `temple/buddhist-monk-chant-2h.mp3` | Chant bouddhiste — mantra de paix (~2 h) | Buddhist Monk Peace Chant | [Internet Archive](https://archive.org/details/39ZenMeditationMusic2HOURSBuddhistMonkPeaceChantHealingMantraChantingPositiveEnergy) | Internet Archive |
